...
![](STAT545_cm014_exploration_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](STAT545_cm014_exploration_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->

If EDA (exploratory data analysis) isn’t enough, we can answer these
questions by fitting a model: a curve that predicts Y given X. Aka, a
**regression curve** or a **machine learning model**.
...
![](STAT545_cm014_exploration_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
