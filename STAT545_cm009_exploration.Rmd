...
use getwd() in Console to return working directory i.e. the file's "home" on your desktop
...
tibble(let = letters,
       ...
       comb = paste(let, num)) #try paste0() for no separation
```
...
#demonstrate how another column can be assigned instead of Words
lotr_tidy %>% 
