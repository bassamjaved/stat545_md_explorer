...
(Data can also be transformed within the aes function)
```{r}
...
Remove Oceania. Add another variable: `lifeExp > 60`. (Creating a new categorical variable for exploration purposes)
