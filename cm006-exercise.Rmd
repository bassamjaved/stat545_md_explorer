...
aes function will default assign first variable to x and second one to y, if no arguments are specified.
...
Histogram is on the scale of a density plot
Density plot juxtaposed on top
